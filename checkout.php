		...
		<div class="container">
						...
						<div class="row">
							<div class="col-md-8">
								<div class="order-notes">
									<h4>Ghi chú</h4>
									<textarea style="height: 115px;width:653px" class="input" placeholder="Thông điệp bánh ngọt ví dụ: 'Chúc mừng sinh nhật'" name="note"></textarea>
								</div>
							</div>
								...
								<?php if (isset($_SESSION['cart'])) :
									...
									foreach ($getAllProducts as $value) :
										if (in_array($value['id'], $ids)) : ?>
											<div class="order-col">
												<img width="145" height="145" alt="poster_1_up" class="shop_thumbnail" src="img/<?php echo $value['pro_image']; ?>">
											...
											<div class="order-col">
												...
												<div style="max-width:440px;"><strong><?php echo number_format($value['price'])?></strong></div>
											</div>
											<div class="order-col">
												<div><strong>SỐ LƯỢNG:</strong></div>
												<div><strong>X <?php echo $_SESSION['cart'][$value['id']]?></strong></div>
											</div>
											<div class="order-col">
												<div><strong>TẠM TÍNH:</strong></div>
												<div><strong class="order-cash-total"><?php echo number_format($_SESSION['cart'][$value['id']] * $value['price']) ?></strong></div>
											</div>
			...
			<div class="order-col">
				<div><strong>TỔNG:</strong></div>
					<div><strong class="order-total"><?php echo number_format($total_cost) ?>VND</strong></div>
				</div>
			<button class="primary-btn order-submit col-lg-offset-4" type="submit" name="submit"  >ĐẶT HÀNG</a></button>
				</div>
			</form>
			</div>
		</div>
